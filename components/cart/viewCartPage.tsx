...
export default function Cart({ user }: CartProps) {
    ...
    return (
    <div className="flex p-6 bg-white h-screen">
        <div className="flex-1 pr-4 max-h-[90vh] o ">
                    ...
                    <ul className="space-y-4">
                        {cartItems.map((item) => (
                            ...
                            >
                                ...
                                <TrashIcon
                                    onClick={() => removeItemFromCart(item.product_id, item.variant_id)}
        ...
        <div className="w-1/4 pl-4 sticky top-6">
