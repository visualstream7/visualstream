                ...
                {ordersData.map((order) => (
                    ...
                    >
                        ...
                        <div className="bg-gray-50 px-6 py-4 flex justify-between items-center">
                            <div>
                                <p className="text-sm text-gray-500">{order.paymentInfo}</p>
                            </div>
                            <div>
                                <p className="text-sm text-gray-600">Delivery Expected:</p>
                                <p className="font-bold text-gray-800">{order.deliveryDate}</p>
                            </div>
                            <div>
                                <p className="text-xl font-extrabold text-gray-800">Total: {order.total}</p>
                            </div>
                        </div>
                    </div>
                ))}
