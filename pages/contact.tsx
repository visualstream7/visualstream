            ...
            <section className="py-10 mb-8 lg:py-6">
                <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="sm:mb-4 lg:p-0">
                        ...
                        <form className="bg-white shadow-lg border border-gray-200 rounded-lg p-6" onSubmit={handleSubmit}>
                            <div className="mb-4">
                            ...
                            <button type="submit" className="w-full bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 transition">
                                Send Message
                            </button>
